...
export interface FlvPlayerReportStatisticsInfo {
    url: string;
    hasRedirect: boolean;
...
export interface FlvPlayerStatisticsInfo extends Partial<FlvPlayerReportStatisticsInfo> {
...
export interface FlvPlayerMediaInfo extends NativePlayerMediaInfo {
    audioCodec?: string;
    videoCodec?: string;
